...
export function CreateAdModal() {
    ...
    <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-20 left-1/2 -translate-x-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
      ...
      <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <select
                name="game"
                id="game"
                className="bg-zinc-900 py-3 px4 rounded text-sm placeholder:text-zinc-500 appearance-none"
                defaultValue=""
            >
